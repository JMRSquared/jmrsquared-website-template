...
export async function runScaffolder() {
  ...
  try {
    ...
    const demoTakedownAt = new Date(demoCreatedAt.getTime() + 14 * 24 * 60 * 60 * 1000);
    ...
    const replacements = {
      ...
      '__DEPLOY_PROVIDER__': provider,
      '__DEPLOY_PROVIDER_NAME__': deployProviderName,
      '__DEPLOY_PROJECT_NAME__': deployProjectName,
      ...
      '__DEMO_CREATED_AT__': demoCreatedAt.toISOString(),
      '__DEMO_TAKEDOWN_AT__': demoTakedownAt.toISOString(),
    };
