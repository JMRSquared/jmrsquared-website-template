...
1. Keep and evolve real 3D/WebGL via React Three Fiber + Drei (starter hero canvas is already present) — CSS decoration alone fails
2. Keep and evolve scroll storytelling via GSAP + ScrollTrigger (starter scroll reveal is already present) plus Motion where useful — fade-in-on-scroll alone fails
